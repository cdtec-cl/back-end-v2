    ...
    public function handle()
    {
        try{
           ...
           /* $measures= Measure::query() 
                            ...
                            ->get();   */                
            //desarrollo
            $measures=Measure::whereIn('id', [4031,4032,4191,4192,4193,4194,4195,4196,4197])->get(); //all();
           //producci{on}
           /*$measures=Measure::whereIn('id', [59,60,61,62,63,64,65,66,67,68,69,70,71,343,344,339,340,341,343,344,342,423,424,425,426,427,428,429,430,705,3238,3239,3241,3243,3244,3245,3345,3351,3353,3374,3375,
                            ...
                            601,602,603,604,605,606,607,609,610,611,612,613,614,701,702,703, 4031,4032,4191,4192,4193,4194,4195,4196,4197])->get(); */

            $initTime=Carbon::now(date_default_timezone_get())->subDays(30)->format('Y-m-d');
